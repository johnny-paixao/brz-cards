...
SCHEMA_CARD_SCORES = [
    ...
    SchemaField("lifetime_faceit_matches",       "INTEGER"),
    SchemaField("AIM",                           "INTEGER"),
    SchemaField("IMP",                           "INTEGER"),
    SchemaField("UTL",                           "INTEGER"),
    SchemaField("CON",                           "INTEGER"),
    SchemaField("INT",                           "INTEGER"),
    SchemaField("EXP",                           "INTEGER"),
    SchemaField("OVERALL",                       "INTEGER"),
    # Diagnostic columns
    SchemaField("BASE_OVERALL",                  "FLOAT"),
    SchemaField("CONTEXT_MULT",                  "FLOAT"),
    SchemaField("RATING_NORM",                   "FLOAT"),
    SchemaField("OPP_ELO_AVG",                   "INTEGER"),
    SchemaField("ADR_norm",                      "FLOAT"),
    SchemaField("HS_norm",                       "FLOAT"),
    SchemaField("KR_norm",                       "FLOAT"),
    SchemaField("RoundSwing_avg",                "FLOAT"),
    SchemaField("UtilSuccess_norm",              "FLOAT"),
    SchemaField("UtilDamageRound_norm",          "FLOAT"),
    SchemaField("FlashSuccess_norm",             "FLOAT"),
    SchemaField("EnemiesFlashedRound_norm",      "FLOAT"),
    SchemaField("CON_raw",                       "FLOAT"),
    SchemaField("INT_score_1v1",                 "FLOAT"),
    SchemaField("INT_score_1v2",                 "FLOAT"),
]
